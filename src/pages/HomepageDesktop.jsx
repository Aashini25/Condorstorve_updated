...
const HomepageDesktop = () => {
  ...
  return (
    <div className="w-full relative bg-gainsboro-100 h-[11302px] overflow-hidden text-left text-5xl text-white font-circular-std">
      <img
        className="absolute top-[0px] left-[0px] w-[1440px] h-[846px] object-cover"
        alt=""
      ...
      <div className="absolute top-[2331px] left-[157px] w-[1283px] h-[794px] overflow-x-auto text-center text-xl font-allenoire-free-personal">
        ...
        />
        <img
          className="absolute top-[0px] left-[374px] rounded-3xs w-[350px] h-[647px] object-cover"
          alt=""
      ...
      <img
        className="absolute top-[846px] left-[0px] w-[1440px] h-[979px] object-cover"
        alt=""
      ...
      <Form className="w-[389px] [border:none] bg-[transparent] absolute top-[9358px] left-[130.7px]">
        <Form.Control type="text" />
      </Form>
      <Form className="w-[792px] [border:none] bg-[transparent] absolute top-[9465px] left-[130.7px]">
        <Form.Control type="text" />
      </Form>
      <Form className="w-[389px] [border:none] bg-[transparent] absolute top-[9358px] left-[533.7px]">
        <Form.Control type="text" />
      </Form>
      ...
      <Button
        className="w-[254px] absolute top-[9514px] left-[959.7px]"
        variant="primary"
      />
      ...
      <div className="absolute top-[10423px] left-[186.7px] w-[982px] flex flex-row items-start justify-start gap-[64px]">
        <Form className="[border:none] bg-[transparent] self-stretch flex-1 font-circular-std text-4xl text-gray-300">
      ...
      <div className="absolute top-[10749px] left-[31.7px] w-[1321px] flex flex-row items-start justify-start py-0 pr-[78px] pl-[84px] box-border gap-[68px] text-4xl text-grey-scale-black-50">
        ...
        <div className="w-[711px] flex flex-row items-start justify-start gap-[121px] text-lg text-gray-300 font-body">
          <div className="flex flex-col items-start justify-start gap-[32px]">
      ...
      <div className="absolute top-[72px] left-[1168px] text-base font-medium inline-block w-[74px]">
        Book now
      </div>
      <img
